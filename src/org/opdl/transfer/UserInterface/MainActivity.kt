...
import org.opdl.transfer.Plugins.SharePlugin.ShareSettingsFragment
...
class MainActivity : AppCompatActivity(), OnSharedPreferenceChangeListener {
    ...
    override fun onStart() {
        ...
        OpdlTransfer.getInstance().addDeviceListChangedCallback(this::class.simpleName!!) { runOnUiThread { updateDeviceList() } }
        updateDeviceList()
    ...
    override fun onStop() {
        OpdlTransfer.getInstance().removeDeviceListChangedCallback(this::class.simpleName!!)
        ...
        when {
            requestCode == RESULT_NEEDS_RELOAD -> {
                CoroutineScope(Dispatchers.IO).launch {
                    OpdlTransfer.getInstance().devices.values.forEach(Device::reloadPluginsFromSettings)
                }
            }
