...
import org.opdl.transfer.Device.PluginsChangedListener
import org.opdl.transfer.Helpers.SecurityHelpers.SslHelper
import org.opdl.transfer.OpdlTransfer
import org.opdl.transfer.PairingHandler
import org.opdl.transfer.Plugins.BatteryPlugin.BatteryPlugin
import org.opdl.transfer.Plugins.MprisPlugin.MprisPlugin
import org.opdl.transfer.Plugins.Plugin
import org.opdl.transfer.Plugins.PresenterPlugin.PresenterPlugin
...
class DeviceFragment : BaseFragment<ActivityDeviceBinding>() {
    ...
    private val device by lazy { OpdlTransfer.getInstance().getDevice(deviceId) }
