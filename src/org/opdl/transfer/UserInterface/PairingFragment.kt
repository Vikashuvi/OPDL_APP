...
import org.opdl.transfer.BackgroundService.Companion.ForceRefreshConnections
import org.opdl.transfer.BackgroundService.Companion.instance
import org.opdl.transfer.Device
import org.opdl.transfer.Helpers.TrustedNetworkHelper.Companion.isTrustedNetwork
import org.opdl.transfer.OpdlTransfer
import org.opdl.transfer.UserInterface.List.ListAdapter
import org.opdl.transfer.UserInterface.List.PairingDeviceItem
...
class PairingFragment : BaseFragment<DevicesListBinding>() {
    ...
    private fun updateDeviceList() {
        ...
        try {
            ...
            val allDevices = OpdlTransfer.getInstance().devices.values.filter {
    ...
    private fun updateConnectivityInfoHeader(isConnectedToNonCellularNetwork: Boolean) {
        val devices: Collection<Device> = OpdlTransfer.getInstance().devices.values
    ...
    override fun onStart() {
        super.onStart()
        OpdlTransfer.getInstance().addDeviceListChangedCallback("PairingFragment") {
    ...
    override fun onStop() {
        OpdlTransfer.getInstance().removeDeviceListChangedCallback("PairingFragment")
        super.onStop()
    }
