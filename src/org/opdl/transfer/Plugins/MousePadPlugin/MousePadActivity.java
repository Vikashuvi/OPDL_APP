...
public class MousePadActivity
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        MousePadPlugin plugin = OpdlTransfer.getInstance().getDevicePlugin(deviceId, MousePadPlugin.class);
        if (plugin == null) {
            finish();
            return;
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        boolean digitizerEnabled =
                OpdlTransfer.getInstance().getDevicePlugin(deviceId, DigitizerPlugin.class) != null;
    ...
    private void showCompose() {
        ...
        intent.putExtra("org.opdl.transfer.Plugins.MousePadPlugin.deviceId", deviceId);
        startActivity(intent);
    }
