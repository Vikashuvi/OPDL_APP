...
public class RunCommandActivity extends BaseActivity<ActivityRunCommandBinding> {
    ...
    private void updateView() {
        RunCommandPlugin plugin = OpdlTransfer.getInstance().getDevicePlugin(deviceId, RunCommandPlugin.class);
        if (plugin == null) {
            finish();
            return;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Device device = OpdlTransfer.getInstance().getDevice(deviceId);
        if (device != null) {
