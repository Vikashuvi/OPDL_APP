...
import org.opdl.transfer.Plugins.ConnectivityReportPlugin.ConnectivityListener.Companion.getInstance
...
class ConnectivityReportPlugin : Plugin() {
    ...
    companion object {
        private const val PACKET_TYPE_CONNECTIVITY_REPORT = "opdltransfer.connectivity_report"
    }
}
