...
class FindMyPhoneReceiver : BroadcastReceiver() {
    companion object {
        const val ACTION_FOUND_IT: String = "org.opdl.transfer.Plugins.FindMyPhonePlugin.foundIt"
    ...
    private fun foundIt(context: Context, intent: Intent) {
        ...
        val plugin = OpdlTransfer.getInstance().getDevicePlugin(deviceId, FindMyPhonePlugin::class.java) ?: return
        plugin.stopPlaying()
    }
}
