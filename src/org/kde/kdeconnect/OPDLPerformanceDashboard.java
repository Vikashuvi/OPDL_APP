...
public class OPDLPerformanceDashboard {
     ...
     */
    public java.util.Map<org.kde.kdeconnect.Helpers.WiFiGenerationDetector.WiFiGeneration, List<OPDLDevice>> 
            getDevicesByWiFiGeneration() {
        java.util.Map<org.kde.kdeconnect.Helpers.WiFiGenerationDetector.WiFiGeneration, List<OPDLDevice>> 
                grouped = new java.util.HashMap<>();
        
        for (OPDLDevice device : connectedDevices) {
            org.kde.kdeconnect.Helpers.WiFiGenerationDetector.WiFiGeneration gen = device.getWifiGeneration();
    ...
    public static class NetworkStatistics {
        ...
        private org.kde.kdeconnect.Helpers.WiFiGenerationDetector.WiFiGeneration dominantWiFiGeneration;
        ...
        public void updateStatistics(List<OPDLDevice> devices) {
            ...
            java.util.Map<org.kde.kdeconnect.Helpers.WiFiGenerationDetector.WiFiGeneration, Integer> genCount = 
            ...
            this.dominantWiFiGeneration = org.kde.kdeconnect.Helpers.WiFiGenerationDetector.WiFiGeneration.UNKNOWN;
            int maxCount = 0;
            for (java.util.Map.Entry<org.kde.kdeconnect.Helpers.WiFiGenerationDetector.WiFiGeneration, Integer> entry : genCount.entrySet()) {
        ...
        public org.kde.kdeconnect.Helpers.WiFiGenerationDetector.WiFiGeneration getDominantWiFiGeneration() { 
